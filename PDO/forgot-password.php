...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM tblpdo WHERE Email=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblpdo  set Password=:newpassword where Email=:email and MobileNumber=:mobile";
...
<head>
  ...
  <title>E-Gram | Forgot Password</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="login.php"><b>PDO</b>!E-Gram</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
