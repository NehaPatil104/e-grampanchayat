							...
							<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									?>									
										<tr>
											...
											<td>
												<a href="javascript:void(0);" onClick="popUpWindow('http://localhost:8080/e-grampanchayat/PDO/complaint/admin/userprofile.php?uid=<?php echo htmlentities($row['id']);?>');" title="View Details">
