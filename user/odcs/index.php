...
<head>
    ...
    <title>Home Page - Online death Certificate System</title>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        <a class="navbar-brand" href="index.php">ODCS</a>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Online Death Certificate System @@ 2021
