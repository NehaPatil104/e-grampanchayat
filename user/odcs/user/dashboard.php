...
<head>
    ...
    <title>Dashboard | Online Death Certificate System</title>
...
{               ?> 
                                        <div class="main-income-phara">
                                           <h2>Welcome to Online Death Certificate Registration <?php  echo $row->FirstName;?>  <?php  echo $row->LastName;?>!!!</h2>
                                        </div>
                                        <?php $cnt=$cnt+1;}} ?>
                                    </div>
                                </div>
