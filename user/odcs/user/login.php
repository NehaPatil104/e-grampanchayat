...
<head>
    ...
    <title>Login | Online death Certificate System</title>
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                                <h3 style="font-weight: bold;color: blue">ODCS</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
...
<p style="text-align: center;"><a href="http://localhost:8080/e-grampanchayat/user/dashboard.php">Back Home!!!</a></p>
                                    </div>
                                </div>
                            </div>
                        </form>
